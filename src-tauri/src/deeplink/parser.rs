...
//!
//! Parses ykwbridge:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ykwbridge:// URL into a DeepLinkImportRequest
///
/// Expected format:
...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ykwbridge" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ykwbridge', got '{scheme}'"
        )));
    }
