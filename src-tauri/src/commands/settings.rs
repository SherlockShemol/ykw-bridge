...
mod tests {
    ...
    fn app_settings_with_webdav(base_url: &str, username: &str, password: &str) -> AppSettings {
        AppSettings {
    ...
    fn save_settings_should_preserve_existing_webdav_when_payload_omits_it() {
        let existing = app_settings_with_webdav("https://dav.example.com", "alice", "secret");
    ...
    fn save_settings_should_keep_incoming_webdav_when_present() {
        let existing = app_settings_with_webdav("https://dav.old.example.com", "old", "old-pass");
        let incoming = app_settings_with_webdav("https://dav.new.example.com", "new", "new-pass");
    ...
    fn save_settings_should_preserve_password_when_incoming_has_empty_password() {
        ...
        let incoming = app_settings_with_webdav("https://dav.example.com", "alice", "");
    ...
    fn save_settings_should_handle_both_empty_passwords() {
        let existing = app_settings_with_webdav("https://dav.example.com", "alice", "");
        let incoming = app_settings_with_webdav("https://dav.example.com", "alice", "");
