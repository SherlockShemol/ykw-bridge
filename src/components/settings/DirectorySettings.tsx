...
interface DirectorySettingsProps {
  ...
  claudeDir?: string;
  onDirectoryChange: (app: ConfigDirectoryApp, value?: string) => void;
  onBrowseDirectory: (app: ConfigDirectoryApp) => Promise<void>;
  onResetDirectory: (app: ConfigDirectoryApp) => Promise<void>;
}
