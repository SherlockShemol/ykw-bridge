...
访问 [Releases](https://github.com/SherlockShemol/ykw-bridge/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/SherlockShemol/ykw-bridge/releases/latest) 下载：

- **Windows**：`YKW-Bridge-Windows.msi` 或 `-Portable.zip`
- **macOS**：`YKW-Bridge-macOS.tar.gz` 或 `.zip`
- **Linux**：`YKW-Bridge-Linux.AppImage` 或 `.deb`
...
- **问题反馈**：[GitHub Issues](https://github.com/SherlockShemol/ykw-bridge/issues)
- **讨论**：[GitHub Discussions](https://github.com/SherlockShemol/ykw-bridge/discussions)
