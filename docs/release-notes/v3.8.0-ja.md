...
YKW Bridge v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/SherlockShemol/ykw-bridge/releases/latest) から入手:

- **Windows**: `YKW-Bridge-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `YKW-Bridge-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `YKW-Bridge-v3.8.0-Linux.AppImage` または `.deb`
...
- **Issue**: [GitHub Issues](https://github.com/SherlockShemol/ykw-bridge/issues)
