...
**[中文更新说明 Chinese Documentation →](https://github.com/SherlockShemol/ykw-bridge/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `YKW-Bridge-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `YKW-Bridge-v3.6.0-Windows.msi`
- **Portable**: `YKW-Bridge-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `YKW-Bridge-v3.6.0-Linux.AppImage`
- **Debian**: `YKW-Bridge-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/SherlockShemol/ykw-bridge/compare/v3.5.1...v3.6.0
