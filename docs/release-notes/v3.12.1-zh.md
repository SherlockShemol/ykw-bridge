...
YKW Bridge v3.12.1 是一个以稳定性改进和 Bug 修复为主的补丁版本。修复了通用配置弹窗无限重复打开的循环问题、WebDAV 同步时的外键约束失败以及多个 i18n 插值问题。同时新增了 **StepFun（阶跃星辰）** 供应商预设、OpenClaw **输入类型选择** 和 **authHeader** 支持，将默认 Gemini 模型升级到 **3.1-pro**，并欢迎四位新赞助商伙伴加入。
...
| 文件                                       | 说明                                |
| ------------------------------------------ | ----------------------------------- |
| `YKW-Bridge-v3.12.1-Windows.msi`            | **推荐** - MSI 安装包，支持自动更新 |
| `YKW-Bridge-v3.12.1-Windows-Portable.zip`   | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                               | 说明                                                      |
| ---------------------------------- | --------------------------------------------------------- |
| `YKW-Bridge-v3.12.1-macOS.zip`      | **推荐** - 解压后拖入 Applications 即可，Universal Binary |
| `YKW-Bridge-v3.12.1-macOS.tar.gz`   | 用于 Homebrew 安装和自动更新                              |
