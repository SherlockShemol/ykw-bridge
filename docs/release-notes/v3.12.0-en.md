...
YKW Bridge v3.12.0 is a feature release focused on provider compatibility, OpenClaw editing, Common Config usability, and sync/data reliability. It restores the **Model Health Check (Stream Check)** UI with improved stability, adds **OpenAI Responses API** format conversion, expands provider presets for **Ucloud**, **Micu**, **X-Code API**, **Novita**, and **Bailian For Coding**, and upgrades **WebDAV sync** with dual-layer versioning.
...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `YKW-Bridge-v3.12.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `YKW-Bridge-v3.12.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                          |
| -------------------------------- | -------------------------------------------------------------------- |
| `YKW-Bridge-v3.12.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `YKW-Bridge-v3.12.0-macOS.tar.gz` | For Homebrew installation and auto-update                            |
