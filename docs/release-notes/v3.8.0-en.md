...
YKW Bridge v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
Visit [Releases](https://github.com/SherlockShemol/ykw-bridge/releases/latest) to download:

- **Windows**: `YKW-Bridge-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `YKW-Bridge-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `YKW-Bridge-v3.8.0-Linux.AppImage` or `.deb`
...
- **Issue Reports**: [GitHub Issues](https://github.com/SherlockShemol/ykw-bridge/issues)
- **Discussions**: [GitHub Discussions](https://github.com/SherlockShemol/ykw-bridge/discussions)
