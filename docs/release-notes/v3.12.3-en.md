...
Added full reverse proxy support for GitHub Copilot, enabling Copilot-authenticated requests to be forwarded through YKW Bridge.
...
Users enable this feature **at their own risk**. YKW Bridge is not responsible for any account restrictions, warnings, or service suspensions resulting from the use of this feature.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `YKW-Bridge-v3.12.3-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `YKW-Bridge-v3.12.3-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `YKW-Bridge-v3.12.3-macOS.dmg`     | **Recommended** - DMG installer, drag to Applications, Universal Binary |
| `YKW-Bridge-v3.12.3-macOS.zip`     | ZIP archive, extract and drag to Applications, Universal Binary      |
| `YKW-Bridge-v3.12.3-macOS.tar.gz`  | For Homebrew installation and auto-update                            |
