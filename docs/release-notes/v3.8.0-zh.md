...
YKW Bridge v3.8.0 是一次重大的架构升级版本，重构了数据持久化层和用户界面，为未来的云同步和本地代理功能奠定基础。
...
- **Windows**：`YKW-Bridge-v3.8.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`YKW-Bridge-v3.8.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`YKW-Bridge-v3.8.0-Linux.AppImage` 或 `.deb`
