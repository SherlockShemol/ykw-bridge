...
YKW Bridge は `ccswitch://` ディープリンクプロトコルをサポートしており、リンクからワンクリックで設定をインポートできます。
...
YKW Bridge はオンラインのディープリンク生成ツールを提供しています：
...
YKW Bridge 公式のオンラインディープリンク生成ツールを使用するとより便利です。
...
1. システムが YKW Bridge を開くかどうかを確認
2. 確認後、YKW Bridge が起動
3. インポート確認ダイアログを表示
4. インポートを確認
...
YKW Bridge のインストール時に `ccswitch://` プロトコルが自動登録されます。
