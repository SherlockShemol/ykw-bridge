...
When enabling an app's toggle, YKW Bridge will:
...
When disabling an app's toggle, YKW Bridge will:
...
If you have already configured MCP servers in CLI tools, you can import them into YKW Bridge:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. YKW Bridge reads the existing configuration and imports it
