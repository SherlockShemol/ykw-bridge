...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (YKW Bridge)
...
After starting the proxy and enabling app takeover, YKW Bridge modifies app configurations:
...
When stopping the proxy, YKW Bridge will:
