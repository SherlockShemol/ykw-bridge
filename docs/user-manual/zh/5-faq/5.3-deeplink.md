...
YKW Bridge 支持 `ccswitch://` 深度链接协议，可以通过链接一键导入配置。
...
使用 YKW Bridge 官方提供的在线深度链接生成工具更方便。
...
YKW Bridge 安装时会自动注册 `ccswitch://` 协议。
