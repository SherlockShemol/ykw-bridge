...
| 字段 | 说明 |
|------|------|
| `models.providers` | 供应商配置（映射为 YKW Bridge 的"供应商"） |
| `env` | 环境变量配置 |
...
YKW Bridge 修改配置时的优先级：

1. **YKW Bridge 数据库** - 单一事实源 (SSOT)
...
YKW Bridge v3.7.0 从 JSON 文件迁移到 SQLite：
